...
#            result = ingest.store_images(lsst_alert, mock_image_store, diaSourceId, imjd)
#            # check we returned something other than None
#            self.assertIsNotNone(result)
#            # check we called putObject twice
#            self.assertEqual(mock_image_store.putObject.call_count, 2)
