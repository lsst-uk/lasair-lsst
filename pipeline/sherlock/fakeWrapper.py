"""Fake Sherlock Kafka wrapper for testing

Randomises ra and dec, uses fake sherlock classifier.
"""
...
def randomise(log, alerts):
    for alert in alerts:
        rand_ra = random.randrange(0, 360000000) / 1000000
