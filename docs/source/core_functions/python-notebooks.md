...
- (Consime Kafka and plot)[https://github.com/lsst-uk/lasair-examples/blob/merge/HS/notebooks/consume_kafka_plot.ipynb]: Shows how to consume Kafka and print the results. You will need to change the topic to the one listed in the webpage for your active filter.
